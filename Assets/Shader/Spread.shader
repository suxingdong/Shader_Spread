Shader "Abenmu/Spread"
{
	Properties
	{
		_ShadowTex("Cookie", 2D) = "" {} //projector 脚本需遮罩
		_MainColor("MainColor", Color) = (1,1,1,1) //主体颜色
		_Forward("Forward", Range(0, 360)) = 0 //方向
		_MinRange("MinRange", Range(0, 0.25)) = 0//最小的圈
		_MaxRange("MaxRange", Range(0, 1)) = 0 //最大圈范围
		_AttackAngle("AttackAngle", Range(0, 360)) = 60 //角度

		_Power("Power", float) = 5 //宽度
